...
function setup() {
    ...
    maze.add(obstacle19)
    maze.add(obstacle20)
    obstacle1.shapeColor=random(colors)    
    obstacle2.shapeColor=random(colors)
    obstacle3.shapeColor=random(colors)
    obstacle4.shapeColor=random(colors)
    obstacle5.shapeColor=random(colors)
    obstacle6.shapeColor=random(colors)
    obstacle7.shapeColor=random(colors)
    obstacle8.shapeColor=random(colors)
    obstacle9.shapeColor=random(colors)
    obstacle10.shapeColor=random(colors)
    obstacle11.shapeColor=random(colors)
    obstacle12.shapeColor=random(colors)
    obstacle13.shapeColor=random(colors)
    obstacle14.shapeColor=random(colors)
    obstacle15.shapeColor=random(colors)
    obstacle16.shapeColor=random(colors)
    obstacle17.shapeColor=random(colors)
    obstacle18.shapeColor=random(colors)
    obstacle19.shapeColor=random(colors)
    obstacle20.shapeColor=random(colors)
    flag = createSprite(60,10,20,20);
}
...
function draw() {
    ...
    if(gameState === End) {
        textSize(30)
        fill('aqua')
        text("You won!!!!! Press R to restart",0,200);
        if(keyDown("R")){
            gameState=Start;
            player.x=200
            player.y = 380
